...
def register_device_route(
    ...
    try:
        ...
        if jwk.kty != "RSA" or jwk.e != "AQAB" or len(jwk.n) != 683 or not re.fullmatch(r'[A-Za-z0-9_\-]+', jwk.n):
            logs_service.add_logs(action="REGISTER_DEVICE_INVALID_PUBLIC_KEY", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        ...
        logs_service.add_logs(action="REGISTER_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return {"device_id": device.id, "is_verified": device.is_verified}
    except Exception as e:
        logs_service.add_logs(action="REGISTER_DEVICE_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
...
def store_device_keys_route(
    ...
    try:
        if len(key_data.ciphered_kek) != 684:
            logs_service.add_logs(action="STORE_DEVICE_KEYS_INVALID_KEK", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        ...
        logs_service.add_logs(action="STORE_DEVICE_KEYS", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return {"status": "Clés stockées avec succès pour le dispositif"}
    except Exception as e:
        logs_service.add_logs(action="STORE_DEVICE_KEYS_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
...
def get_device_keys_route(
    ...
    try:
        ...
        logs_service.add_logs(action="GET_DEVICE_KEYS", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return device_keys
    except Exception as e:
        logs_service.add_logs(action="GET_DEVICE_KEYS_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
...
def list_unverified_devices_route(
    ...
    try:
        ...
        logs_service.add_logs(action="LIST_UNVERIFIED_DEVICES", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return unverified_devices
    except Exception as e:
        logs_service.add_logs(action="LIST_UNVERIFIED_DEVICES_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
...
def verify_device_route(
    ...
    try:
        ...
        logs_service.add_logs(action="VERIFY_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return {"device_id": device.id, "is_verified": device.is_verified}
    except Exception as e:
        logs_service.add_logs(action="VERIFY_DEVICE_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
...
def list_verified_devices_route(
    ...
    try:
        ...
        logs_service.add_logs(action="LIST_VERIFIED_DEVICES", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return verified_devices
    except Exception as e:
        logs_service.add_logs(action="LIST_VERIFIED_DEVICES_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
...
def reject_device_route(
    ...
    try:
        ...
        logs_service.add_logs(action="REJECT_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return {"status": "Dispositif refusé avec succès"}
    except Exception as e:
        logs_service.add_logs(action="REJECT_DEVICE_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
...
def revoke_device_route(
    ...
    try:
        ...
        logs_service.add_logs(action="REVOKE_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
        return {"status": "Dispositif révoqué avec succès"}
    except Exception as e:
        logs_service.add_logs(action="REVOKE_DEVICE_ERROR", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null")
