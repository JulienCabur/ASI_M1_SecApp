...
async def register_device_route(
    ...
    try:
        ...
        if jwk.kty != "RSA" or jwk.e != "AQAB" or len(jwk.n) != 683 or not re.fullmatch(r'[A-Za-z0-9_\-]+', jwk.n):
            await logs_service.add_logs(action="REGISTER_DEVICE_INVALID_PUBLIC_KEY", log_level="ERROR", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Invalid RSA-OAEP 4096 bits public key provided")
        ...
        await logs_service.add_logs(action="REGISTER_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Device registered successfully")
...
async def store_device_keys_route(
    ...
    try:
        ...
        await logs_service.add_logs(action="STORE_DEVICE_KEYS", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Device keys stored successfully")
...
async def get_device_keys_route(
    ...
    try:
        ...
        await logs_service.add_logs(action="GET_DEVICE_KEYS", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Device keys retrieved successfully")
        return device_keys
    except Exception as e:
...
async def list_unverified_devices_route(
    ...
    try:
        ...
        await logs_service.add_logs(action="LIST_UNVERIFIED_DEVICES", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Unverified devices listed successfully")
...
async def verify_device_route(
    ...
    try:
        ...
        await logs_service.add_logs(action="VERIFY_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Device verified successfully")
        return {"device_id": device.id, "is_verified": device.is_verified}
    except Exception as e:
...
async def list_verified_devices_route(
    ...
    try:
        ...
        await logs_service.add_logs(action="LIST_VERIFIED_DEVICES", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Verified devices listed successfully")
...
async def reject_device_route(
    ...
    try:
        ...
        await logs_service.add_logs(action="REJECT_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Device rejected successfully")
...
async def revoke_device_route(
    ...
    try:
        ...
        await logs_service.add_logs(action="REVOKE_DEVICE", log_level="INFO", user_id=current_user.id, user_role=current_user.roles[0], patient_id="null", message="Device revoked successfully")
