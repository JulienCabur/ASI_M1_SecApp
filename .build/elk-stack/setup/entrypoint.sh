...
users_passwords=(
	...
	[logstash_alerts_writer]="${LOGSTASH_ALERTS_PASSWORD:-}"
...
users_roles=(
	...
	[logstash_alerts_writer]='security_alerts_writer'
...
roles_files=(
	...
	[security_alerts_writer]='security_alerts_writer.json'
	[security_alerts_reader]='security_alerts_reader.json'
